...

{
  ...
  this.Given(/^the user is a registered user$/, function(callback) 
  {
    ...
    // a first name, last name, birthdate and stree address, zipcode, city
    ...
    //assert(aPerson.lastName === 'Andersson', "The firstName of the person is different from the one used to create the person.");
    // ....
    callback();
  });
